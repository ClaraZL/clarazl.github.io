...
bookConfig.macBookVersion = "HLQSvsIFQemjPFRdplEEdbstIGXUknCKaYtkCAYXioKDfUsnJEZTpjEGQZrtGLVbmtBKaenmACXQutLHcbrtEObcirBLdRjuKMfbnpAGQYhoFFRbrqNEfVnuJCRfvuHHWQpmLAUX74055C28_";
...
bookConfig.bookTitle="Edicion Maestros5";
bookConfig.normalPath="./files/mobile/";
bookConfig.largePath="./files/mobile/";
bookConfig.productName="Flip PDF Professional";
bookConfig.useTheAliCloudChart=false;
bookConfig.MidBgColor="#3bfe5f";
bookConfig.bookmarkCR = "f4e9f35513d6591009e5e6e99f05ad58fe4bbee9";
