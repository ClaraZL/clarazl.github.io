...
bookConfig.macBookVersion = "NNZZgpFMTSjlJFUeunEFQfupKHeTsmLKcRrmCGSTkoKEXavhEMWVqsLHTSqhOETXrrKPQSkhALaXvpKIRehlHDXRvrEHVbguNMcQqhOIdWqtLMQVsv0d3A356c_";
...
bookConfig.largePageWidth=486;
bookConfig.largePageHeight=666;
bookConfig.bookTitle="EnlaEscuela";
bookConfig.normalPath="./files/mobile/";
bookConfig.largePath="./files/mobile/";
bookConfig.productName="Flip PDF Professional";
bookConfig.useTheAliCloudChart=false;
bookConfig.MidBgColor="#4d5a37";
bookConfig.bookmarkCR = "f38bd069060e384b2c1d994757cd7413ba30cbf1";
