...
bookConfig.macBookVersion = "KIWWqqHMZdgrPHScvtCIcfrsMLYfhiLGYfgvOHVfsvFIbckvJDQVnuICVXjlBKXagqGBccgmPIeQtoNOXanqNKdUhlPCSasgNIaVvhOIUeskJAXUqqODSdttLPeZqnFPYVsoNLVeF3324366_";
bookConfig.Html5Template = "Metro";
bookConfig.UIBaseURL="mobile/";
bookConfig.isFlipPdf=false;
bookConfig.searchTextJS="mobile/javascript/search_config.js";
bookConfig.searchPositionJS="mobile/javascript/text_position[1].js";
bookConfig.totalPageCount=14;
bookConfig.largePageWidth=612;
bookConfig.largePageHeight=792;
bookConfig.bookTitle="Edicion Maestros3";
bookConfig.normalPath="./files/mobile/";
bookConfig.largePath="./files/mobile/";
bookConfig.productName="Flip PDF Professional";
bookConfig.useTheAliCloudChart=false;
bookConfig.MidBgColor="#5ac145";
bookConfig.bookmarkCR = "29634850a13112ec767cebda84c7e73333f3810c";
